...
change_pen_up_down = Button(frame_right, text="Pen is Down", command=change_pen_up_down, width=10)
...
start_animation_button = Button(frame_right, text="Start Animation", command=start_animation, bg="#434448", fg="yellow", width=10)
...
save_as_png_btn = Button(frame_right, text="Screenshot!", command=save_as_png, bg="#434448", fg="yellow", width=10)
