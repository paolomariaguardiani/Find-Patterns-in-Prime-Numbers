...
def start_animation(*args):
    ...
    t.pencolor(color_pen)
    for i in range(iterations_number):
        for i in range(numero_lati - 1):  # numero_lati - 2
...
start_animation_button = Button(frame_comandi, text="Start Animation", command=start_animation6, width=10)
...
num_side_slider = ttk.Scale(frame_comandi, from_=1, to=30, command=change_num_size, orient=HORIZONTAL, value=6)
